...
void biodata(){
    printf("Program membaca file teks, menghitung jumlah kata dan waktu eksekusi\n");
    printf("=================================================================\n");
...
void hitungDenganFscanf(FILE *file, int *jumlahKata, int *jumlahKarakter, int *jumlahBaris) {
    ...
    *jumlahKata = *jumlahKarakter = *jumlahBaris = 0;
    ...
    // Menghitung kata menggunakan fscanf
